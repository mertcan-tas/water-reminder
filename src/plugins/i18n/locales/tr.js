export default {
  ...
  pages: {
    home: {
      ...
      target: "Hedef",
      liter: "Litre",
      target_complated_msg: "Hedef Tamamlandı",
      drinking_water_msg: "Litre içildi",
      add_liter_button_title: "Su Ekle",
      add_liter_button_subtitle: "İçtiğin suyu kaydet",
      add_dialog: {
        dialog_title: "Ne Kadar Su İçtin?",
        add_quick: "Hızlı Ekle",
        water_amount: "Su Miktarı",
        liter: "Litre",
        add_quick_glass: "Bardak",
        add_quick_bottle: "Şişe",
        add_quick_big_bottle: "Büyük Şişe",
        validation_required_msg: "Miktar boş olamaz.",
        validation_positive_value_msg:
          "Geçerli bir su miktar girin (0'dan büyük).",
        dialog_cancel_button: "Vazgeç",
        dialog_add_button: "Ekle",
      },
    },
    profile: {
      title: "Profilim",
